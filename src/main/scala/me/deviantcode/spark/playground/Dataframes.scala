...
import me.deviantcode.spark.playground.models.Flight
...
object Dataframes extends App with SparkSessionManager {
  override def logger = LoggerFactory.getLogger(getClass)
